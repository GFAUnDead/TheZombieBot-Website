			...
			<div id="wrapper">
					<div id="main">
							<section id="about">
								<div class="container">
									<header class="major">
										<h2>TheWereWolfBot</h2>
										<p>What is TheWereWolfBot?<br>
											‌It is the Twitch Chat Bot built by gfaUnDead.<br>
											This bot is for chat interactions!</p>
									</header>
									<p></p>
								</div>
							</section>
								...
								<div class="container">
									...
									<ul class="feature-icons">
										<li><strong>PUBLIC:</strong>
											...
											<br />!sad
											<br />!sleep
											<br />hi (Say hi, hello, g'day or howdy in chat for the bot to say hi to you!)
										</li>
									</ul>
								</div>
							</section>
